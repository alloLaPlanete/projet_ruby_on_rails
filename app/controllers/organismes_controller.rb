class OrganismesController < ApplicationController
  ...
  def create
    ...
    @organisme = current_deviseuser.organismes.build(organisme_params)   #Permet de referer l'id du createur         
  ...
  private
    ...
    def organisme_params
      params.require(:organisme).permit(:nom, :adresse, :telephone, :courriel)
    end
end
