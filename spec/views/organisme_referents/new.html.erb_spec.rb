...
RSpec.describe "organisme_referents/new", type: :view do
  before(:each) do
    assign(:organisme_referent, OrganismeReferent.new(
  ...
  it "renders new organisme_referent form" do
    render

    assert_select "form[action=?][method=?]", organisme_referents_path, "post" do
